...
module.exports = {
  ...
  overrides: [{
    ...
    rules: {
      'no-shadow': 'off',
      '@typescript-eslint/no-base-to-string': ['error', { ignoredTypeNames: ['TextChannel', 'VoiceBasedChannel'] }],
      // Turned off because `strictNullChecks` in tsconfig.json is set to false.
